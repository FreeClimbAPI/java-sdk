...
public class CallsRequesterTest {
	...
	public void placeApplicationCall(String from, String to, String applicationId) throws Throwable {
		...
		callOptions.setApplicationId(applicationId);
		CreateCallRequest query = new CreateCallRequest(from, to, callOptions);
		...
		assertTrue(this.callsR.create(from, to, callOptions).equals(Call.fromJson(CallsRequesterTest.aTestCall)));
	}
