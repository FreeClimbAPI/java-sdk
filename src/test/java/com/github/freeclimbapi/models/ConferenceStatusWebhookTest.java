...
/**
 * Model tests for ConferenceStatusWebhook
 */
 public class ConferenceStatusWebhookTest {
    
    private final ConferenceStatusWebhook model = new ConferenceStatusWebhook(
    );
    ...
    public void equalsTrueTest() {
      ConferenceStatusWebhook test1 = new ConferenceStatusWebhook();
      ...
      ConferenceStatusWebhook test2 = new ConferenceStatusWebhook();
    ...
    public void deserializeTest() {
      String json = "{ \"requestType\": \"conferenceStatus\" }";
      ConferenceStatusWebhook webhookInstance = ConferenceStatusWebhook.deserialize(json);
      Assert.assertTrue(webhookInstance instanceof ConferenceStatusWebhook);
    }
