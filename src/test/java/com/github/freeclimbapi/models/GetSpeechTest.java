...
public class GetSpeechTest {
    ...
    public void buildTest() throws Exception {
        ...
        Assert.assertEquals(
                attributes.get("recognitionTimeoutMs"), model.getRecognitionTimeoutMs());
        ...
        Assert.assertEquals(
                attributes.get("speechCompleteTimeoutMs"), model.getSpeechCompleteTimeoutMs());
        Assert.assertEquals(
                attributes.get("speechIncompleteTimeoutMs"), model.getSpeechIncompleteTimeoutMs());
