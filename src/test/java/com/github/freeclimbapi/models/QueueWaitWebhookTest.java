...
/**
 * Model tests for QueueWaitWebhook
 */
 public class QueueWaitWebhookTest {
    
    private final QueueWaitWebhook model = new QueueWaitWebhook(
    );
    ...
    public void queuePositionTest() {
      ...
      model.setQueuePosition("TEST_STRING");
      Assert.assertEquals("TEST_STRING", model.getQueuePosition());
    ...
    public void currentQueueSizeTest() {
      ...
      model.setCurrentQueueSize(1);
      Assert.assertEquals(1, (int) model.getCurrentQueueSize());
    }
    ...
    public void equalsTrueTest() {
      QueueWaitWebhook test1 = new QueueWaitWebhook();
    ...
    public void deserializeTest() {
      String json = "{ \"requestType\": \"queueWait\" }";
      QueueWaitWebhook webhookInstance = QueueWaitWebhook.deserialize(json);
      Assert.assertTrue(webhookInstance instanceof QueueWaitWebhook);
    }
