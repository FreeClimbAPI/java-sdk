...
/** Model tests for OutDialStartWebhook */
public class OutDialStartWebhookTest {

    private final OutDialStartWebhook model = new OutDialStartWebhook();
    ...
    public void dialCallIdTest() {
        ...
        model.setDialCallId("TEST_STRING");
        Assert.assertEquals("TEST_STRING", model.getDialCallId());
    }
    ...
    public void equalsTrueTest() {
        OutDialStartWebhook test1 = new OutDialStartWebhook();
        ...
        OutDialStartWebhook test2 = new OutDialStartWebhook();
    ...
    public void deserializeTest() {
        String json = "{ \"requestType\": \"outDialStart\" }";
        OutDialStartWebhook webhookInstance = OutDialStartWebhook.deserialize(json);
        Assert.assertTrue(webhookInstance instanceof OutDialStartWebhook);
    }
}
