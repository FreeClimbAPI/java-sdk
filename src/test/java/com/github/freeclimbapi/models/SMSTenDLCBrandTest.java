...
public class SMSTenDLCBrandTest {
    ...
    private final SMSTenDLCBrand model =
            new SMSTenDLCBrand("TEST_STRING", "TEST_STRING", "TEST_STRING");
    ...
    public void brandRelationshipTest() {
        ...
        Assert.assertEquals(
                model.getBrandRelationship(), SMSTenDLCBrandRelationship.MEDIUM_ACCOUNT);
    ...
    public void identityStatusTest() {
        ...
        Assert.assertEquals(
                model.getIdentityStatus(), SMSTenDLCBrandIdentityStatus.VETTED_VERIFIED);
    }
