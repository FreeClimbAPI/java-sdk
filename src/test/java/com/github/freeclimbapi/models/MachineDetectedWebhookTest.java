...
/** Model tests for MachineDetectedWebhook */
public class MachineDetectedWebhookTest {

    private final MachineDetectedWebhook model = new MachineDetectedWebhook();
    ...
    public void machineTypeTest() {
        model.setMachineType(MachineType.ANSWERING_MACHINE);
        Assert.assertEquals(model.getMachineType(), MachineType.ANSWERING_MACHINE);
        model.setMachineType(MachineType.FAX_MODEM);
        Assert.assertEquals(model.getMachineType(), MachineType.FAX_MODEM);
    }

    /** Test the method 'equalsTrue' */
    @Test
    public void equalsTrueTest() {
        MachineDetectedWebhook test1 = new MachineDetectedWebhook();
    ...
    public void deserializeTest() {
        String json = "{ \"requestType\": \"machineDetected\" }";
        MachineDetectedWebhook webhookInstance = MachineDetectedWebhook.deserialize(json);
        Assert.assertTrue(webhookInstance instanceof MachineDetectedWebhook);
    }
}
