...
/** Model tests for AudioStreamWebhook */
public class AudioStreamWebhookTest {

    private final AudioStreamWebhook model = new AudioStreamWebhook();
    ...
    public void equalsTrueTest() {
        AudioStreamWebhook test1 = new AudioStreamWebhook();
        ...
        AudioStreamWebhook test2 = new AudioStreamWebhook();
    ...
    public void deserializeTest() {
        String json = "{ \"requestType\": \"audioStream\" }";
        AudioStreamWebhook webhookInstance = AudioStreamWebhook.deserialize(json);
        Assert.assertTrue(webhookInstance instanceof AudioStreamWebhook);
    }
}
