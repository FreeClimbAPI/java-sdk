...
/**
 * Model tests for RedirectWebhook
 */
 public class RedirectWebhookTest {
    
    private final RedirectWebhook model = new RedirectWebhook(
    );
    ...
    public void equalsTrueTest() {
      RedirectWebhook test1 = new RedirectWebhook();
      ...
      RedirectWebhook test2 = new RedirectWebhook();
    ...
    public void deserializeTest() {
      String json = "{ \"requestType\": \"redirect\" }";
      RedirectWebhook webhookInstance = RedirectWebhook.deserialize(json);
      Assert.assertTrue(webhookInstance instanceof RedirectWebhook);
    }
