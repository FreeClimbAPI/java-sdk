...
/** Model tests for ReplaceBlobRequest */
public class ReplaceBlobRequestTest {

    private final ReplaceBlobRequest model = new ReplaceBlobRequest();
    ...
    public void equalsTrueTest() {
        ReplaceBlobRequest test1 = new ReplaceBlobRequest();

        Object testObjectObject = new Object();
        test1.setBlob(testObjectObject);

        ReplaceBlobRequest test2 = new ReplaceBlobRequest();
