...
/**
 * Model tests for RemoveFromQueueNotificationWebhook
 */
 public class RemoveFromQueueNotificationWebhookTest {
    
    private final RemoveFromQueueNotificationWebhook model = new RemoveFromQueueNotificationWebhook(
    );
    ...
    public void queueResultTest() {
      model.setQueueResult(QueueResultStatus.QUEUE_FULL);
      Assert.assertEquals(model.getQueueResult(),QueueResultStatus.QUEUE_FULL);
      model.setQueueResult(QueueResultStatus.DEQUEUED);
      Assert.assertEquals(model.getQueueResult(),QueueResultStatus.DEQUEUED);
      model.setQueueResult(QueueResultStatus.HANGUP);
      Assert.assertEquals(model.getQueueResult(),QueueResultStatus.HANGUP);
      model.setQueueResult(QueueResultStatus.SYSTEM_ERROR);
      Assert.assertEquals(model.getQueueResult(),QueueResultStatus.SYSTEM_ERROR);
    ...
    public void equalsTrueTest() {
      RemoveFromQueueNotificationWebhook test1 = new RemoveFromQueueNotificationWebhook();
    ...
    public void deserializeTest() {
      String json = "{ \"requestType\": \"removeFromQueueNotification\" }";
      RemoveFromQueueNotificationWebhook webhookInstance = RemoveFromQueueNotificationWebhook.deserialize(json);
      Assert.assertTrue(webhookInstance instanceof RemoveFromQueueNotificationWebhook);
    }
