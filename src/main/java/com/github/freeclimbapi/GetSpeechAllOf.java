...
public class GetSpeechAllOf {
  ...
  public GetSpeechAllOf actionUrl(String actionUrl) {
  ...
  **/
  ...
  public GetSpeechAllOf grammarType(Integer grammarType) {
  ...
  **/
  ...
  public GetSpeechAllOf grammarRule(Boolean grammarRule) {
  ...
  **/
  ...
  public GetSpeechAllOf playBeep(String playBeep) {
