...
public class IncomingNumberResult {
     ...
     * This field will be rendered only for requests to the IncomingPhone number resource.
     *
     * @return offnet
     */
    @javax.annotation.Nullable
    @ApiModelProperty(
            value =
                    "The offnet field is a boolean representing whether the number is offnet"
                        + " registered or not. This field will be rendered only for requests to the"
                        + " IncomingPhone number resource.")
