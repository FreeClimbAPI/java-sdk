...
/**
 * A queued call has been dequeued and the actionUrl of the corresponding Enqueue action is being
 * invoked. A PerCL response is expected.
 */
@ApiModel(
        description =
                "A queued call has been dequeued and the actionUrl of the corresponding Enqueue"
                        + " action is being invoked. A PerCL response is expected.")
...
public class DequeueWebhook extends Webhook {
    ...
    /**
     * Context or reason why this request is being made. Will be dequeue - A queued call has been
     * dequeued and the actionUrl of the corresponding Enqueue action is being invoked.
     *
     * @return requestType
     */
    ...
    @ApiModelProperty(
            value =
                    "Context or reason why this request is being made. Will be dequeue - A queued"
                        + " call has been dequeued and the actionUrl of the corresponding Enqueue"
    ...
    /**
     * The final result of the enqueued Call. Valid values are: •dequeued - Enqueued caller exited
     * the Queue via a Dequeue action (Dequeue command or Queue Members POST REST API).
     *
     * @return queueResult
     */
    @javax.annotation.Nullable
    @ApiModelProperty(
            value =
                    "The final result of the enqueued Call. Valid values are: •dequeued - Enqueued"
                        + " caller exited the Queue via a Dequeue action (Dequeue command or Queue"
                        + " Members POST REST API).")
