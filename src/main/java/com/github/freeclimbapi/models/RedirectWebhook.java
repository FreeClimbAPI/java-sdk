 ...
 */
@ApiModel(description = "The Redirect command is executing and its actionUrl is being invoked. A PerCL response is expected.")
...
public class RedirectWebhook extends Webhook {
  ...
  **/
  ...
  @ApiModelProperty(value = "Context or reason why this request is being made. Will be redirect - The Redirect command is executing and its actionUrl is being invoked.")
