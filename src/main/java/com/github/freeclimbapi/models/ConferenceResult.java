...
public class ConferenceResult {
    ...
    public ConferenceResult playBeep(PlayBeep playBeep) {
    ...
    public ConferenceResult status(ConferenceStatus status) {
    ...
    /**
     * URL referencing the audio file to be used as default wait music for the Conference when it is
    ...
    @ApiModelProperty(
            value =
                    "URL referencing the audio file to be used as default wait music for the"
                            + " Conference when it is in the populated state.")
    ...
    @ApiModelProperty(
            value =
                    "The list of subresources for this Conference. This includes participants"
                            + " and/or recordings.")
