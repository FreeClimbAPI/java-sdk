...
public class QueueMember {
    ...
    /**
     * Date that the Member was enqueued (GMT), given in RFC 1123 format (e.g., Mon, 15 Jun 2009
     * 20:45:30 GMT).
     *
     * @return dateEnqueued
     */
    ...
    @ApiModelProperty(
            value =
                    "Date that the Member was enqueued (GMT), given in RFC 1123 format (e.g., Mon,"
