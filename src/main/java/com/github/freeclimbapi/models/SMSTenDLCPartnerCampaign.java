...
public class SMSTenDLCPartnerCampaign {
    ...
    private SMSTenDLCPartnerCampaignStatus status;
    ...
    @ApiModelProperty(
            ...
            value =
                    "Alphanumeric identifier assigned by the registry for a campaign. This"
                            + " identifier is required by the NetNumber OSR SMS enabling process of"
                            + " 10DLC.")
    ...
    public SMSTenDLCPartnerCampaign status(SMSTenDLCPartnerCampaignStatus status) {
    ...
    public SMSTenDLCPartnerCampaignStatus getStatus() {
        return status;
    }

    public void setStatus(SMSTenDLCPartnerCampaignStatus status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.accountId, smSTenDLCPartnerCampaign.accountId)
                ...
                && Objects.equals(
                        this.affiliateMarketing, smSTenDLCPartnerCampaign.affiliateMarketing)
