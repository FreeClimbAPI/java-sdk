 ...
 */
@ApiModel(description = "A Conference has been created and its statusCallbackUrl or actionUrl is being invoked. A PerCL response is expected if the actionUrl is being invoked.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CreateConferenceWebhook extends Webhook {
  public static CreateConferenceWebhook deserialize(String payload) {
    return (CreateConferenceWebhook)(new JSON().getGson().fromJson(payload, Webhook.class));
  }
  ...
  public CreateConferenceWebhook requestType(String requestType) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Context or reason why this request is being made. Will be createConference - A Conference has been created and its statusCallbackUrl or actionUrl is being invoked.")
  ...
  public CreateConferenceWebhook callId(String callId) {
  ...
  **/
  ...
  public CreateConferenceWebhook accountId(String accountId) {
  ...
  **/
  ...
  public CreateConferenceWebhook from(String from) {
  ...
  **/
  ...
  public CreateConferenceWebhook to(String to) {
  ...
  **/
  ...
  public CreateConferenceWebhook callStatus(CallStatus callStatus) {
  ...
  **/
  ...
  public CreateConferenceWebhook direction(CallDirection direction) {
  ...
  **/
  ...
  public CreateConferenceWebhook conferenceId(String conferenceId) {
  ...
  **/
  ...
  public CreateConferenceWebhook queueId(String queueId) {
  ...
  **/
  ...
  public CreateConferenceWebhook status(ConferenceStatus status) {
  ...
  **/
  ...
  public CreateConferenceWebhook recordingUrl(String recordingUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The URL of the Conference’s recorded audio. Populated only if a Recording exists and the Conference was emptied. Present only if statusCallbackUrl is being invoked.")
  ...
  public CreateConferenceWebhook recordingId(String recordingId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique ID of the Recording from this Conference. Populated only if a Recording exists and the Conference was emptied. Present only if statusCallbackUrl is being invoked.")
  ...
  public CreateConferenceWebhook recordingDurationSec(Integer recordingDurationSec) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The duration of the recorded audio rounded up to the nearest second (in seconds). Populated only if a Recording exists and the Conference was emptied. Present only if statusCallbackUrl is being invoked.")
  ...
  public boolean equals(Object o) {
    ...
    CreateConferenceWebhook createConferenceWebhook = (CreateConferenceWebhook) o;
    return Objects.equals(this.requestType, createConferenceWebhook.requestType) &&
        Objects.equals(this.callId, createConferenceWebhook.callId) &&
        Objects.equals(this.accountId, createConferenceWebhook.accountId) &&
        Objects.equals(this.from, createConferenceWebhook.from) &&
        Objects.equals(this.to, createConferenceWebhook.to) &&
        Objects.equals(this.callStatus, createConferenceWebhook.callStatus) &&
        Objects.equals(this.direction, createConferenceWebhook.direction) &&
        Objects.equals(this.conferenceId, createConferenceWebhook.conferenceId) &&
        Objects.equals(this.queueId, createConferenceWebhook.queueId) &&
        Objects.equals(this.status, createConferenceWebhook.status) &&
        Objects.equals(this.recordingUrl, createConferenceWebhook.recordingUrl) &&
        Objects.equals(this.recordingId, createConferenceWebhook.recordingId) &&
        Objects.equals(this.recordingDurationSec, createConferenceWebhook.recordingDurationSec) &&
        super.equals(o);
  }
