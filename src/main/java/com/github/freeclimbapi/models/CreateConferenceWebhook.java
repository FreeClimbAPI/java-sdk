...
/**
 * A Conference has been created and its statusCallbackUrl or actionUrl is being invoked. A PerCL
 * response is expected if the actionUrl is being invoked.
 */
@ApiModel(
        description =
                "A Conference has been created and its statusCallbackUrl or actionUrl is being"
                    + " invoked. A PerCL response is expected if the actionUrl is being invoked.")
...
public class CreateConferenceWebhook extends Webhook {
    ...
    /**
     * Context or reason why this request is being made. Will be createConference - A Conference has
     * been created and its statusCallbackUrl or actionUrl is being invoked.
     *
     * @return requestType
     */
    ...
    @ApiModelProperty(
            value =
                    "Context or reason why this request is being made. Will be createConference - A"
                        + " Conference has been created and its statusCallbackUrl or actionUrl is"
                        + " being invoked.")
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.requestType, createConferenceWebhook.requestType)
                ...
                && Objects.equals(
                        this.recordingDurationSec, createConferenceWebhook.recordingDurationSec)
                && super.equals(o);
    }
