...
public class UpdateConferenceParticipantRequest {
    ...
    /**
     * (Optional) Default is &#x60;true&#x60;. Setting to &#x60;false&#x60; mutes the Participant.
    ...
    /**
     * (Optional) Default is &#x60;true&#x60;. Setting to &#x60;false&#x60; silences the Conference
     * for this Participant. FreeClimb returns an error and ignores any other value.
     *
     * @return listen
     */
    @javax.annotation.Nullable
    @ApiModelProperty(
            value =
                    "(Optional) Default is `true`. Setting to `false` silences the Conference for"
                            + " this Participant. FreeClimb returns an error and ignores any other"
                            + " value.")
    ...
    /**
     * (Optional) Default is &#x60;true&#x60;. Setting to &#x60;false&#x60; mutes dtmf audio for
     * this Participant. FreeClimb returns an error and ignores any other value.
     *
    ...
    @ApiModelProperty(
            value =
                    "(Optional) Default is `true`. Setting to `false` mutes dtmf audio for this"
                        + " Participant. FreeClimb returns an error and ignores any other value.")
    ...
    public boolean equals(Object o) {
        ...
        UpdateConferenceParticipantRequest updateConferenceParticipantRequest =
                (UpdateConferenceParticipantRequest) o;
        return Objects.equals(this.talk, updateConferenceParticipantRequest.talk)
                ...
                && Objects.equals(
                        this.dtmfPassThrough, updateConferenceParticipantRequest.dtmfPassThrough);
    }
