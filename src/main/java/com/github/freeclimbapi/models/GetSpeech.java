...
/**
 * The &#x60;GetSpeech&#x60; command enables the Caller to respond to the application using a
 * supported language. Unlike DTMF entry, which implicitly restricts the user to using the available
 * buttons on the phone key pad, speech input allows for flexible audio inputs based on grammar.
 * FreeClimb supports grammars written using GRXML compatible with the Microsoft Speech Platform.
 * &#x60;GetSpeech&#x60; is only supported on a single call leg. It is not supported when there are
 * two or more call legs connected (as in within a Conference).
 */
@ApiModel(
        description =
                "The `GetSpeech` command enables the Caller to respond to the application using a"
                    + " supported language. Unlike DTMF entry, which implicitly restricts the user"
                    + " to using the available buttons on the phone key pad, speech input allows"
                    + " for flexible audio inputs based on grammar. FreeClimb supports grammars"
                    + " written using GRXML compatible with the Microsoft Speech Platform."
                    + " `GetSpeech` is only supported on a single call leg. It is not supported"
                    + " when there are two or more call legs connected (as in within a"
                    + " Conference).")
...
public class GetSpeech extends PerclCommand {
    ...
    public static final String SERIALIZED_NAME_SPEECH_COMPLETE_TIMEOUT_MS =
            "speechCompleteTimeoutMs";

    @SerializedName(SERIALIZED_NAME_SPEECH_COMPLETE_TIMEOUT_MS)
    private Integer speechCompleteTimeoutMs;

    public static final String SERIALIZED_NAME_SPEECH_INCOMPLETE_TIMEOUT_MS =
    ...
    public GetSpeech actionUrl(URI actionUrl) {
    ...
    /**
     * When the caller has finished speaking or the command has timed out, FreeClimb will make a
     * POST request to this URL. A PerCL response is expected to continue handling the call.
     *
     * @return actionUrl
     */
    ...
    @ApiModelProperty(
            required = true,
            value =
                    "When the caller has finished speaking or the command has timed out, FreeClimb"
                        + " will make a POST request to this URL. A PerCL response is expected to"
                        + " continue handling the call.")
    ...
    public GetSpeech grammarType(GrammarType grammarType) {
    ...
    /**
     * The grammar file to use for speech recognition. If grammarType is set to URL, this attribute
     * is specified as a download URL.
     *
     * @return grammarFile
     */
    @javax.annotation.Nonnull
    @ApiModelProperty(
            required = true,
            value =
                    "The grammar file to use for speech recognition. If grammarType is set to URL,"
                            + " this attribute is specified as a download URL.")
    ...
    public GetSpeech grammarRule(String grammarRule) {
    ...
    /**
     * The grammar rule within the specified grammar file to use for speech recognition. This
     * attribute is optional if &#x60;grammarType&#x60; is &#x60;URL&#x60; and ignored if
     * &#x60;grammarType&#x60; is &#x60;BUILTIN&#x60;.
     *
     * @return grammarRule
     */
    @javax.annotation.Nullable
    @ApiModelProperty(
            value =
                    "The grammar rule within the specified grammar file to use for speech"
                        + " recognition. This attribute is optional if `grammarType` is `URL` and"
                        + " ignored if `grammarType` is `BUILTIN`.")
    ...
    public GetSpeech playBeep(Boolean playBeep) {
    ...
    /**
     * Indicates whether a beep should be played just before speech recognition is initiated so that
     * the speaker can start to speak.
     *
     * @return playBeep
     */
    @javax.annotation.Nullable
    @ApiModelProperty(
            value =
                    "Indicates whether a beep should be played just before speech recognition is"
                            + " initiated so that the speaker can start to speak.")
    ...
    /**
     * The JSON array of PerCL commands to nest within the &#x60;GetSpeech&#x60; command. The
     * &#x60;Say&#x60;, &#x60;Play&#x60;, and &#x60;Pause&#x60; commands can be used. The nested
     * actions are executed while FreeClimb is waiting for input from the caller. This allows for
     * playing menu options to the caller and to prompt for the expected input. These commands stop
     * executing when the caller begins to input speech.
     *
     * @return prompts
     */
    @javax.annotation.Nullable
    @ApiModelProperty(
            value =
                    "The JSON array of PerCL commands to nest within the `GetSpeech` command. The"
                        ...
                        + " executed while FreeClimb is waiting for input from the caller. This"
                        + " allows for playing menu options to the caller and to prompt for the"
                        + " expected input. These commands stop executing when the caller begins to"
                        + " input speech.")
    ...
    @ApiModelProperty(
            value =
                    "When recognition is started and there is no speech detected for"
                            + " `noInputTimeoutMs` milliseconds, the recognizer will terminate the"
    ...
    /**
     * When a recognition resource recognizes a spoken phrase, it associates a confidence level with
     * that match. Parameter &#x60;confidenceThreshold&#x60; specifies what confidence level is
     * considered a successful match. Values are between 0.0 and 1.0.
     *
    ...
    @ApiModelProperty(
            value =
                    "When a recognition resource recognizes a spoken phrase, it associates a"
                            + " confidence level with that match. Parameter `confidenceThreshold`"
     ...
     * attribute allows for filtering out background noise, so it is not mistaken for speech. Values
    ...
    @ApiModelProperty(
            value =
                    "The speech recognizer supports a variable level of sound sensitivity. The"
                        + " sensitivityLevel attribute allows for filtering out background noise,"
                        + " so it is not mistaken for speech. Values are between 0.0 and 1.0 ")
    ...
    /**
     * Parameter &#x60;speechCompleteTimeoutMs&#x60; specifies the length of silence required
     * following user speech before the speech recognizer finalizes a result. This timeout applies
     * when the recognizer currently has a complete match against an active grammar. Reasonable
     * speech complete timeout values are typically in the range of 0.3 seconds to 1.0 seconds.
     *
    ...
    @ApiModelProperty(
            value =
                    "Parameter `speechCompleteTimeoutMs` specifies the length of silence required"
                        + " following user speech before the speech recognizer finalizes a result."
                        + " This timeout applies when the recognizer currently has a complete match"
                        + " against an active grammar. Reasonable speech complete timeout values"
                        + " are typically in the range of 0.3 seconds to 1.0 seconds.")
    ...
    /**
     * Parameter &#x60;speechIncompleteTimeoutMs&#x60; specifies the length of silence following
     * user speech after which a recognizer finalizes a result. This timeout applies when the speech
     * prior to the silence is an incomplete match of all active grammars. Timeout
     * &#x60;speechIncompleteTimeoutMs&#x60; is usually longer than
     * &#x60;speechCompleteTimeoutMs&#x60; to allow users to pause mid-utterance.
     *
    ...
    @ApiModelProperty(
            value =
                    "Parameter `speechIncompleteTimeoutMs` specifies the length of silence"
                        + " following user speech after which a recognizer finalizes a result. This"
                        + " timeout applies when the speech prior to the silence is an incomplete"
                        + " match of all active grammars. Timeout `speechIncompleteTimeoutMs` is"
                        + " usually longer than `speechCompleteTimeoutMs` to allow users to pause"
                        + " mid-utterance.")
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
            value = "Parameter privacyMode will not log the `text` as required by PCI compliance.")
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.actionUrl, getSpeech.actionUrl)
                ...
                && Objects.equals(
                        this.speechIncompleteTimeoutMs, getSpeech.speechIncompleteTimeoutMs)
    ...
    public String toString() {
        ...
        sb.append("    recognitionTimeoutMs: ")
                .append(toIndentedString(recognitionTimeoutMs))
                .append("\n");
        ...
        sb.append("    speechCompleteTimeoutMs: ")
                .append(toIndentedString(speechCompleteTimeoutMs))
                .append("\n");
        sb.append("    speechIncompleteTimeoutMs: ")
                .append(toIndentedString(speechIncompleteTimeoutMs))
                .append("\n");
