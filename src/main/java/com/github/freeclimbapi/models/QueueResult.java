...
public class QueueResult {
    ...
    public static final String SERIALIZED_NAME_AVERAGE_QUEUE_REMOVAL_TIME =
    ...
    @ApiModelProperty(
            value =
                    "The maximum number of Calls permitted in the Queue. Default is 100. Maximum is"
                            + " 1000.")
    ...
    @ApiModelProperty(
            value =
                    "The average amount of time (in seconds) for a call to be removed from the"
                            + " queue.")
