...
public class MessageResult {
  ...
  **/
  ...
  public MessageResult notificationUrl(URI notificationUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "String that uniquely identifies the phoneNumber resource used to send this Message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "String that uniquely identifies the Application resource used to send this Message")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uri, dateCreated, dateUpdated, revision, accountId, messageId, status, from, to, text, direction, notificationUrl, brandId, campaignId, segmentCount, mediaUrls, tfn, phoneNumberId, applicationId);
  }
