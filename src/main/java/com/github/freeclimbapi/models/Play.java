...
/**
 * The &#x60;Play&#x60; command plays an audio file back to the caller. The audio file may be
 * located at any location accessible via a URL. &#x60;Play&#x60; can exist as a stand-alone command
 * or as a nested command. It does not allow barge-in unless nested within a &#x60;GetSpeech&#x60;
 * command. The file will always be played to completion unless nested.
 */
@ApiModel(
        description =
                "The `Play` command plays an audio file back to the caller. The audio file may be"
                    + " located at any location accessible via a URL. `Play` can exist as a"
                    + " stand-alone command or as a nested command. It does not allow barge-in"
                    + " unless nested within a `GetSpeech` command. The file will always be played"
...
public class Play extends PerclCommand {
    ...
    @ApiModelProperty(
            ...
            value =
                    "RL of the audio file to be played to the caller. The URL can be the"
                            ...
                            + " `StartRecordCall` PerCL commands. ")
    ...
    /**
     * Number of times the audio file is played. Specifying &#39;0&#39; causes the Play action to
