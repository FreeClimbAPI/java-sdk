 ...
 */
@ApiModel(description = "The RecordUtterance command has completed and its actionUrl is being invoked.")
...
public class RecordWebhook extends Webhook {
  ...
  **/
  ...
  @ApiModelProperty(value = "The context or reason why this request is being made. Will be record - The RecordUtterance command has completed and its actionUrl is being invoked.")
  ...
  **/
  ...
  public RecordWebhook recordingUrl(String recordingUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "URL of the recorded audio file. This URL can be used as is in a Play command to play the recording (no authentication needed). It can also be used to download a recording file via the REST API.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Duration of the recorded audio rounded up to the nearest second (in seconds)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If true then it indicates the recording will only be available for download for two minutes prior to it being deleted. This is to minimize risk of anyone else getting access to the url and attempting to access it.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestType, accountId, callId, from, to, callStatus, direction, conferenceId, queueId, recordingId, recordingUrl, recordingSize, recordingFormat, recordingDurationSec, termReason, parentCallId, privacyMode, super.hashCode());
  }
