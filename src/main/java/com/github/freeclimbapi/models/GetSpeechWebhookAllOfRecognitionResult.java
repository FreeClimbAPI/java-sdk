 ...
 */
@ApiModel(description = "Semantic content (either a string if speech was recognized or a digit if a digit was input instead of speech) returned from the entry or tag that was recognized within the grammar. The content will be replaced by 'xxxxx' when privacyMode is set to true. This field is populated only if the reason field is set to recognition or digit.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class GetSpeechWebhookAllOfRecognitionResult {
  public static String getDiscriminatorValue() {
    return null;
  }

  public GetSpeechWebhookAllOfRecognitionResult() { 
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSpeechWebhookAllOfRecognitionResult {\n");
    sb.append("}");
    return sb.toString();
  }
