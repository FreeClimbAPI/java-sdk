...
public class AccountResult {
    ...
    @ApiModelProperty(
            value =
                    "The API key assigned to this account. This key must be kept a secret by the"
                            + " customer.")
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
            value = "A string that identifies a category or group to which the account belongs.")
