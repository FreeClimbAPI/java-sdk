 ...
 */
@ApiModel(description = "The statusCallbackUrl request includes Recording information for a Conference that ended. This is a notification only; any PerCL returned will be ignored.")
...
public class ConferenceRecordingStatusWebhook extends Webhook {
  public static ConferenceRecordingStatusWebhook deserialize(String payload) {
    return (ConferenceRecordingStatusWebhook)(new JSON().getGson().fromJson(payload, Webhook.class));
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Context or reason why this request is being made. Will be conferenceRecordingStatus - The statusCallbackUrl request includes Recording information for a Conference that ended.")
  ...
  **/
  ...
  public ConferenceRecordingStatusWebhook recordingUrl(String recordingUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ConferenceRecordingStatusWebhook conferenceRecordingStatusWebhook = (ConferenceRecordingStatusWebhook) o;
    return Objects.equals(this.requestType, conferenceRecordingStatusWebhook.requestType) &&
        ...
        Objects.equals(this.recordingDurationSec, conferenceRecordingStatusWebhook.recordingDurationSec) &&
        super.equals(o);
  }
