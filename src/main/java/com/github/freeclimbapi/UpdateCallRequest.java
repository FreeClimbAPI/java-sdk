...
public class UpdateCallRequest {
  ...
  public UpdateCallRequest status(StatusEnum status) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Either `canceled` or `completed`.  Specifying `canceled` attempts to hang up calls that are queued without affecting calls already in progress. Specifying `completed` attempts to hang up a call already in progress.")
